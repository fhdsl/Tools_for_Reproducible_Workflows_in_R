...
:::dictionary
CI/CD is a software practice, now also used by science that automates the process of building, testing, and releasing analyses and code.  CI/CD practices are often implemented by automation 'pipelines'. 
:::
...
:::dictionary
A GitHub-based automation service that allows you to implement CI/CD pipelines.
::: 
