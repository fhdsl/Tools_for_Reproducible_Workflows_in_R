...
Thus the pane that is below this new pane  is where we can test out code, but the top pane is where we can write code that we wish to save. 
...
This pane will be the pane that we look at most of the time as we create reports that demonstrate exactly how we did our analyses. We will discuss more about R Markdown files in the next section.
