...
Although other options like SPSS and SAS exist to help you do statistical analysis, R is especially useful at getting messy data ready to analyze and R is also particularly powerful for creating useful plots to represent patterns in data.  Conveniently, R can do all of these and does not require users to switch between different programs to perform all these aspects of a data project. R also helps create reports that can demonstrate to collaborators and others exactly howan analysis was performed, aiding in the transparency of how the data was used from start to finish.
