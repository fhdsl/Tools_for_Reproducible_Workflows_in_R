...
This first chunk tells the document how additional chunks should show up in the rendered report by default. Here it says that code should be "echoed" with `echo = TRUE` in the report. You don't need to worry to much about any of this now, just recognize that this is a chunk of code. 
