...
Before we begin to jump into additional tools that can help us to be work more efficiently and in a more reproducible manner, it is helpful to review some nifty features of RStudio that are very helpful.

- Understand how to con


- Explain why project organization helps with work efficiency and reproducibility
- Recognize how RStudio projects help organize file structures
- Explain how R recognizes file paths to locate files that you want to work with
- Illustrate how different file organizations result in different paths
- Explain how the `here` package makes file paths in your code more easily usable by coworkers
- Describe how the `ProjectTemplate` package can help you organize projects
