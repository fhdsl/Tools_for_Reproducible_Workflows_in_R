...
<img src="04-rstudio-tour_files/figure-html//1MNHf8JpolaEP_vQ_kB-1xRBF9wo3haCArRu117hBoHA_g21a84b32106_0_0.png" title="A Tour of RStudio, Learning Objectives are to be able to, Recognize why RStudio is useful, Install RStudio and get started with it, Navigate RStudio" alt="A Tour of RStudio, Learning Objectives are to be able to, Recognize why RStudio is useful, Install RStudio and get started with it, Navigate RStudio" width="100%" style="display: block; margin: auto;" />
...
<img src="04-rstudio-tour_files/figure-html//1MNHf8JpolaEP_vQ_kB-1xRBF9wo3haCArRu117hBoHA_g20ed7630a13_1_0.png" title="Once you go to the r project website, you can click on the CRAN button to download the latest version of R" alt="Once you go to the r project website, you can click on the CRAN button to download the latest version of R" width="100%" style="display: block; margin: auto;" />
...
<img src="04-rstudio-tour_files/figure-html//1MNHf8JpolaEP_vQ_kB-1xRBF9wo3haCArRu117hBoHA_g20ed7630a13_1_11.png" title="CRAN mirror list" alt="CRAN mirror list" width="100%" style="display: block; margin: auto;" />
...
<img src="04-rstudio-tour_files/figure-html//1MNHf8JpolaEP_vQ_kB-1xRBF9wo3haCArRu117hBoHA_g20ed7630a13_1_19.png" title="Page to download R for computers with different operating systems, such as Mac or Windows" alt="Page to download R for computers with different operating systems, such as Mac or Windows" width="100%" style="display: block; margin: auto;" />
...
<img src="04-rstudio-tour_files/figure-html//1MNHf8JpolaEP_vQ_kB-1xRBF9wo3haCArRu117hBoHA_g20ed7630a13_1_30.png" title="The Posit website for downloading RStudio" alt="The Posit website for downloading RStudio" width="100%" style="display: block; margin: auto;" />
...
<img src="04-rstudio-tour_files/figure-html//1MNHf8JpolaEP_vQ_kB-1xRBF9wo3haCArRu117hBoHA_g20ed7630a13_1_37.png" title="The free version of RStudio is likely all you need." alt="The free version of RStudio is likely all you need." width="100%" style="display: block; margin: auto;" />
...
<img src="04-rstudio-tour_files/figure-html//1MNHf8JpolaEP_vQ_kB-1xRBF9wo3haCArRu117hBoHA_g20ed7630a13_1_37.png" title="Select the appropriate link to download RStudio according to the type of computer you have." alt="Select the appropriate link to download RStudio according to the type of computer you have." width="100%" style="display: block; margin: auto;" />
...
<img src="04-rstudio-tour_files/figure-html//1MNHf8JpolaEP_vQ_kB-1xRBF9wo3haCArRu117hBoHA_g20ed7630a13_1_58.png" title="Drag and drop RStudio into the Applications folder to install on a Mac." alt="Drag and drop RStudio into the Applications folder to install on a Mac." width="100%" style="display: block; margin: auto;" />
...
<img src="04-rstudio-tour_files/figure-html//1MNHf8JpolaEP_vQ_kB-1xRBF9wo3haCArRu117hBoHA_g20ed7630a13_1_50.png" title="Check for updates for RStudio in the Help menu of RStudio." alt="Check for updates for RStudio in the Help menu of RStudio." width="100%" style="display: block; margin: auto;" />
...
<img src="04-rstudio-tour_files/figure-html//1MNHf8JpolaEP_vQ_kB-1xRBF9wo3haCArRu117hBoHA_g229ab7a949e_0_557.png" title="An example of the popup that shows you that you are using the newest version of RStudio." alt="An example of the popup that shows you that you are using the newest version of RStudio." width="100%" style="display: block; margin: auto;" />

With recent versions RStudio will also give you a popup to let you know that you could update.

<img src="04-rstudio-tour_files/figure-html//1MNHf8JpolaEP_vQ_kB-1xRBF9wo3haCArRu117hBoHA_g229ab7a949e_0_563.png" title="Popup indicating that you could update RStudio." alt="Popup indicating that you could update RStudio." width="100%" style="display: block; margin: auto;" />
...
<img src="04-rstudio-tour_files/figure-html//1MNHf8JpolaEP_vQ_kB-1xRBF9wo3haCArRu117hBoHA_g20ed7630a13_1_67.png" title="When RStudio is first opened you will see 3 panes" alt="When RStudio is first opened you will see 3 panes" width="100%" style="display: block; margin: auto;" />
...
<img src="04-rstudio-tour_files/figure-html//1MNHf8JpolaEP_vQ_kB-1xRBF9wo3haCArRu117hBoHA_g22370a5f292_430_0.png" title="Select Edit and then Preferences to get to the menu about pane layout." alt="Select Edit and then Preferences to get to the menu about pane layout." width="100%" style="display: block; margin: auto;" />
...
<img src="04-rstudio-tour_files/figure-html//1MNHf8JpolaEP_vQ_kB-1xRBF9wo3haCArRu117hBoHA_g22370a5f292_430_5.png" title="The Pane Layout menu allows you to modify the layout of RStudio. This shows the default settings with Source on the top left, Console on the bottom left, Environment, History, Connections, and Build on the top right, and Files, Plots, Packages, Help, VCS (version control) on the bottom right." alt="The Pane Layout menu allows you to modify the layout of RStudio. This shows the default settings with Source on the top left, Console on the bottom left, Environment, History, Connections, and Build on the top right, and Files, Plots, Packages, Help, VCS (version control) on the bottom right." width="100%" style="display: block; margin: auto;" />
...
<img src="04-rstudio-tour_files/figure-html//1MNHf8JpolaEP_vQ_kB-1xRBF9wo3haCArRu117hBoHA_g20ed7630a13_1_81.png" title="The pane on the left is where we write and test code." alt="The pane on the left is where we write and test code." width="100%" style="display: block; margin: auto;" />
...
<img src="04-rstudio-tour_files/figure-html//1MNHf8JpolaEP_vQ_kB-1xRBF9wo3haCArRu117hBoHA_g20ed7630a13_1_95.png" title="The pane on the upper right is where we see our objects." alt="The pane on the upper right is where we see our objects." width="100%" style="display: block; margin: auto;" />
...
<img src="04-rstudio-tour_files/figure-html//1MNHf8JpolaEP_vQ_kB-1xRBF9wo3haCArRu117hBoHA_g20ed7630a13_1_109.png" title="The pane on the lower right is where we see our files, plots, and where we get help." alt="The pane on the lower right is where we see our files, plots, and where we get help." width="100%" style="display: block; margin: auto;" />
...
<img src="04-rstudio-tour_files/figure-html//1MNHf8JpolaEP_vQ_kB-1xRBF9wo3haCArRu117hBoHA_g20ed7630a13_1_142.png" title="In Pane one, in our Console window, we can run code interactively. Here we are running the code head(iris) which prints out a data set about flowers for us to look at. " alt="In Pane one, in our Console window, we can run code interactively. Here we are running the code head(iris) which prints out a data set about flowers for us to look at. " width="100%" style="display: block; margin: auto;" />
...
<img src="04-rstudio-tour_files/figure-html//1MNHf8JpolaEP_vQ_kB-1xRBF9wo3haCArRu117hBoHA_g1fa1583c827_0_4.png" title="If you create an object in RStudio, it will show up in the environment pane." alt="If you create an object in RStudio, it will show up in the environment pane." width="100%" style="display: block; margin: auto;" />
...
<img src="04-rstudio-tour_files/figure-html//1MNHf8JpolaEP_vQ_kB-1xRBF9wo3haCArRu117hBoHA_g20ed7630a13_1_127.png" title="Creating an R Markdown file in RStudio by selecting File, New File, R Markdown." alt="Creating an R Markdown file in RStudio by selecting File, New File, R Markdown." width="100%" style="display: block; margin: auto;" />

Creating an R Markdown file starts with a pop-up and you can simply click the OK button.

<img src="04-rstudio-tour_files/figure-html//1MNHf8JpolaEP_vQ_kB-1xRBF9wo3haCArRu117hBoHA_g20ed7630a13_1_169.png" title="Creating an R Markdown file starts with a pop-up and you can simply click the OK button." alt="Creating an R Markdown file starts with a pop-up and you can simply click the OK button." width="100%" style="display: block; margin: auto;" />

The new pane will open on the upper left.


<img src="04-rstudio-tour_files/figure-html//1MNHf8JpolaEP_vQ_kB-1xRBF9wo3haCArRu117hBoHA_g20ed7630a13_1_176.png" title="The new pane will open on the upper left." alt="The new pane will open on the upper left." width="100%" style="display: block; margin: auto;" />
...
<img src="04-rstudio-tour_files/figure-html//1MNHf8JpolaEP_vQ_kB-1xRBF9wo3haCArRu117hBoHA_g20ed7630a13_1_186.png" title="The new pane will open on the upper left and is for writing code we want to save, while the bottom pane is for writing code we want to test." alt="The new pane will open on the upper left and is for writing code we want to save, while the bottom pane is for writing code we want to test." width="100%" style="display: block; margin: auto;" />

The top pane where we save code is called the Editor. The lower pane for quick tests of code is called the Console.

<img src="04-rstudio-tour_files/figure-html//1MNHf8JpolaEP_vQ_kB-1xRBF9wo3haCArRu117hBoHA_g20ed7630a13_1_198.png" title="The Editor in the top left, also called source, is where we write code we want to save. The lower left is the Console where we do quick tests of our code." alt="The Editor in the top left, also called source, is where we write code we want to save. The lower left is the Console where we do quick tests of our code." width="100%" style="display: block; margin: auto;" />
