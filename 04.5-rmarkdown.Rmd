...
```{r, fig.align='center', out.width="100%", echo = FALSE, fig.alt= "The chunk run menu button is located to the right of the new chunk button. Click the arrow next to it to get more advanced options."}
