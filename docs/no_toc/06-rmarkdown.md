...
### Quarto Pros:
- Built with more compatability for other languages
...
Using `date: "2024-11-20"` in the YAML will keep the date up-to-date as you write more code. It will display the date that the report was last rendered.
