...
Generally at the end of your notebook, you will want to print out your sesion info. You can do this by running the function `sessionInfo()` or the tidyverse version of this function from the devtools package, `devtools::session_info()`.
