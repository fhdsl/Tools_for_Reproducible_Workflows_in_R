...
```{r, fig.align='center', out.width="100%", echo = FALSE, fig.alt= "The structure of directories or folders that are created using the ProjectTemplate package."}
ottrpal::include_slide("https://docs.google.com/presentation/d/1MNHf8JpolaEP_vQ_kB-1xRBF9wo3haCArRu117hBoHA/edit#slide=id.g33c01fedb5a_0_188")
```
...
You can use this package to help you create consistent directory structures across projects and to help you not forget making README files. 
