...
To get started you can follow these steps to make a custom function:

### Starting a new function

Open up a new R script file and copy and paste our basic template we have below.
...
1. It's likely you might already have some code drafted that has some of the code you need for your function.
paste this code in the part of this template that says `# Your main code here`.
...
2. First let's write a `@description` field. What is this function's goal.
3. Next you'll likely want to sculpt your code, carefully thinking about its usage  and what types of options may need to be controlled by those who will use this function.
