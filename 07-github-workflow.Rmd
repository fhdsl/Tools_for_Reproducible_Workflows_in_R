...
Git has its own set of terms that we need to use in order to communicate about it. We will briefly define them here but don't stress if it doesn't completely make sense to you just yet. As we walk through the typical workflow steps, it will make more sense!
