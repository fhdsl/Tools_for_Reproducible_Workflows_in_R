...
Many R projects are not really finished, they are either maintained long term or they deprecate. Many folks have many R projects over time which means keeping all your R projects maintained could easily become a time consuming endeavor!
...
Building some of the infrastructure we will describe will take a bit more time upfront, but will save you time long term.
...
There are lots of ready made GitHub Actions for use with R code. Take a look at the usethis R package library https://usethis.r-lib.org/reference/github_actions.html
