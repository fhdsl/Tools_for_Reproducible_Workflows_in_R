...
- it helps you write code by making suggestions to complete what you have written - currently this is mostly for suggesting package names or functions (which are specific pieces of code that accomplish a particular task, often packages have several functions)
...
Next we want to download RStudio. You can do so by going to the Posit website at this link: https://posit.co/.
...
The pane on the left (labeled "Pane 1" in the image) is where we write code.
